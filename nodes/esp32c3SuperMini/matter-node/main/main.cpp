...
{
    switch (s) {
    case IndicatorState::Boot:                  return "boot/blue-breathe";
    case IndicatorState::Commissioning:         return "commissioning/blue-double-pulse";
    case IndicatorState::WiFiDisconnected:      return "wifi-disconnected/blue-slow-blink";
    case IndicatorState::Running:               return "running/blue-steady-dim";
    case IndicatorState::CommissioningPreview:  return "btn-preview-commissioning/blue-fast-blink";
    case IndicatorState::FactoryResetPreview:   return "btn-preview-factory-reset/blue-warning";
    case IndicatorState::FactoryResetActive:    return "factory-reset/blue-rapid";
    }
    return "?";
}
...
{
    // Most ESP32-C3 SuperMini boards expose an active-low blue status LED on GPIO8.
