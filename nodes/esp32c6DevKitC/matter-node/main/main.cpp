...
// ESP32-C6-DevKitC-1 has an onboard addressable RGB LED on GPIO8.
// Use the standard channel order for this board profile.
esp_err_t set_led_color(uint8_t r, uint8_t g, uint8_t b, uint8_t intensity)
{
    ...
    return led_strip_refresh(s_device.led_strip);
}
